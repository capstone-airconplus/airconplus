    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbUpload(ariconText.getText().toString());

//                DatabaseReference myRef = mDB.getReference(userUID);
////                email = emailText.getText().toString();
////                aircon_name = ariconText.getText().toString();
////
////                myRef.child("email").push().setValue(email);
////                myRef.child("aircon_name").push().setValue(aircon_name);
    ...
    public void dbUpload(String aircon_name){
