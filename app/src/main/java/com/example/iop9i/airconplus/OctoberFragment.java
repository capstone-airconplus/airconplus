...
public class OctoberFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        entries.add(new BarEntry(8, 80));
        entries.add(new BarEntry(7, 90));
        entries.add(new BarEntry(8, 100));
        entries.add(new BarEntry(9, 10));
        entries.add(new BarEntry(10, 20));
        entries.add(new BarEntry(11, 00));
        entries.add(new BarEntry(12, 40));
        entries.add(new BarEntry(13, 30));
        entries.add(new BarEntry(14, 200));
        entries.add(new BarEntry(15, 40));
        entries.add(new BarEntry(16, 30));
        entries.add(new BarEntry(17, 10));
        entries.add(new BarEntry(18, 20));
        entries.add(new BarEntry(19, 300));
        entries.add(new BarEntry(20, 40));
        entries.add(new BarEntry(21, 30));
        entries.add(new BarEntry(22, 00));
        entries.add(new BarEntry(23, 40));
        entries.add(new BarEntry(24, 30));
        entries.add(new BarEntry(25, 10));
        entries.add(new BarEntry(26, 20));
        entries.add(new BarEntry(27, 30));
        entries.add(new BarEntry(28, 40));
        entries.add(new BarEntry(29, 30));
        entries.add(new BarEntry(30, 500));
        entries.add(new BarEntry(31, 40));
