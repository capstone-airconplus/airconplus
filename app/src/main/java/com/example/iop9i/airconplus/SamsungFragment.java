...
public class SamsungFragment extends Fragment {
    ...
    private TextView samsung_crawling7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        samsung_crawling7 = (TextView) v.findViewById (R.id.samsungcrawling7);
...
*/
        ...
        samsung_crawling7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent = new Intent (Intent.ACTION_VIEW, Uri.parse("[안성수] [오후 8:35] https://www.samsungsvc.co.kr/online/faqList.do?pageNo=1&page=1&searchOrder=PAGE_CREATED_DATE_DESC&Lcode=&faq=&video=&download=&diagnosis=&coreword2=%BD%BA%C5%C4%B5%E5+%BF%A1%BE%EE%C4%C1&coreword1=%BF%A1%BE%EE%C4%C1&code=S021&searchTarget=&selectCtgrCodeFAQ=NODE0000145783&presearchTarget=&selectCtgrCodeDIAGNOSIS=NODE0000125081&selectCtgrCodeVIDEO=NODE0000125157&selectCtgrCodeDOWNLOAD=CAC&anchorG=Y&q=&w=srch_faq&sq=&vsq=&dsort=&fsort=&oneCode=&pg=&onSrch=&faqListOrderBy=&d1=&d2=#anc"));
                startActivity (myintent);
            }
